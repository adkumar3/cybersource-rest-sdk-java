...
public class TokenAuthCapture {
    public static void main(String[] args) {
        ...
        // Cryptogram = Unique encrypted value that is dynamically generated by a chip and used for authentication for in-app transactions.
        // In-app transaction = E-commerce transaction for which an application on the customer’s mobile device provides the token data.
        ...
        // E-Commerce Indicator 7 (Internet) for CTV gateway and ApplePay payment solution.
