...
public class SearchPaymentById {
	public static void main(String[] args) {
		...
		if(args.length!=1){
			System.out.println("Transaction ID is not provided in command line argument. ");
			System.exit(1);
		}
		else if(args[0].equals("-help")){
			System.out.println("Specify a transaction ID to return a specific payment resource" + "\n" + 
