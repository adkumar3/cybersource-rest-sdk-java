...
public class PaymentTest {
    ...
    public void setup() throws URISyntaxException, IOException {
        ...
        File file = new File(Thread.currentThread().getContextClassLoader().getResource("Payment.json").toURI());
    ...
    public void testDeserialize() throws ApiException, IllegalAccessException, InvocationTargetException {
        TypeRef typeRef = new TypeRef<com.cybersource.payments.model.Payment>() {};
        JSON json = new JSON();
        Payment instanceOfPayment = json.deserialize(serialized, typeRef);
        ...
        for(Method method : methods){
            ...
            if (method.getDeclaringClass() == Payment.class && method.getName().startsWith("get")) {
                assertTrue(method.invoke(instanceOfPayment) != null);
            }
        }
	}
}
