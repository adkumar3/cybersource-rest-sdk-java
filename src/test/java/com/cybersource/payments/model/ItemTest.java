...
public class ItemTest {
    ...
    public void setup() throws URISyntaxException, IOException {
        ...
        File file = new File(Thread.currentThread().getContextClassLoader().getResource("Item.json").toURI());
    ...
    public void testDeserialize() throws ApiException, IllegalAccessException, InvocationTargetException {
        TypeRef typeRef = new TypeRef<com.cybersource.payments.model.Item>() {};
        JSON json = new JSON();
        Item instanceOfItem = json.deserialize(serialized, typeRef);
        ...
        for(Method method : methods){
            ...
            if (method.getDeclaringClass() == Item.class && method.getName().startsWith("get")) {
                assertTrue(method.invoke(instanceOfItem) != null);
            }
        }
	}
}
